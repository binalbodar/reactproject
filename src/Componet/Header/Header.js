        ...
        <ul className="navbar-nav ml-auto">
          ...
          <li className="nav-item dropdown">
            ...
            <div className="dropdown-menu" aria-labelledby="dropdown04">
              ...
              <NavLink exact className="dropdown-item" to={"/shop"}>Shop</NavLink>
              {/* <a className="dropdown-item" href="product-single.html">Single Product</a> */}
              <NavLink exact className="dropdown-item" to={"/singalproduct"}>Single Product</NavLink>
              {/* <a className="dropdown-item" href="cart.html">Cart</a> */}
              <NavLink exact className="dropdown-item" to={"/cart"}>Cart</NavLink>
              {/* <a className="dropdown-item" href="checkout.html">Checkout</a> */}
              <NavLink exact className="dropdown-item" to={"/checkout"}>Checkout</NavLink>
            </div>
          </li>
